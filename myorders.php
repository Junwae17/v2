...
$produk = mysqli_query($koneksi, "SELECT * FROM transaksi INNER JOIN produk ON transaksi.produk =  produk.idproduk INNER JOIN user ON transaksi.user = user.username WHERE status NOT LIKE 'K' AND user = '$username'");
